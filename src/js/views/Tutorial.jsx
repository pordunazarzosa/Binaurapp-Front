        ...
        <>
            ...
            <div className="container">
                <div id="indexImg" className="row tm-albums-container grid">
                    <div className="col-sm-6 col-lg-3 col-xl-3 tm-album-col">
                    ...
                    <div className="col-sm-6 col-12 col-sm-6 col-lg-3 col-xl-3 tm-album-col">
                            ...
                            <div id="start-section" className="row">
                                <div className="col-lg-3 order-lg-1 ">
                                    <figure className="effect-sadie" onClick={handleDisplayInfoFirst} >
                                        <img id="imageCard" className="rounded mx-auto d-block" src={"https://t4.ftcdn.net/jpg/08/17/40/67/240_F_817406710_lQakfpC6ZYSlsumK4CdhFCbDk3kcHdnr.jpg"} alt="Image" />
                                        <figcaption>
                                            <h2>More info</h2>
                                        </figcaption>
                                    </figure>
                            ...
                            <div id="mixer-section" className="row">
                                <div className="col-lg-3 order-lg-1 ">
                                    <figure className="effect-sadie" onClick={handleDisplayInfoSecond} >
                                        <img id="imageCard" className="rounded mx-auto d-block" src={"https://t4.ftcdn.net/jpg/07/50/49/35/240_F_750493557_N6hSYv6tcZhUhK5SShxrWn9bENnKESAX.jpg"} alt="Image" />
                                        <figcaption>
                                            <h2>More info</h2>
                                        </figcaption>
                                    </figure>
                        ...
                        <div id="binaurappCard" className="card">
                            <div id="playlist-section" className="row">
                                ...
                                <figure className="effect-sadie" onClick={handleDisplayInfoThird}>
                                    <img id="imageCard" className="rounded mx-auto d-block" src={"https://t3.ftcdn.net/jpg/08/12/94/64/240_F_812946424_rGuEESUckxezrXv1oMy7zHUVtIk8TtPX.jpg"} alt="Image"/>
                                    <figcaption>
                                        <h2>More info</h2>
                                    </figcaption>
                                </figure>
                            ...
                            <div id="what-section" className="row">
                                <div className="col-md-3 order-md-1 ">
                                    <figure className="effect-sadie" onClick={handleDisplayInfoFourth} >
                                        <img id="imageCard" className="rounded mx-auto d-block" src={"https://t3.ftcdn.net/jpg/06/96/32/52/240_F_696325264_lODIXcco4tGRdjJzZAlXFC87wOoR398u.jpg"} alt="Image"/>
                                        <figcaption>
                                            <h2>More info</h2>
                                        </figcaption>
                                    </figure>
